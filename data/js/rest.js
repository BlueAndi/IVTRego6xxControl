...
IVTRego6xxController.rest = {};

IVTRego6xxController.rest.Client = function(options) {
    this._hostname  = "";
...
IVTRego6xxController.rest.Client.prototype.listFiles = function(path = "/", page = "0") {
...
IVTRego6xxController.rest.Client.prototype.listAllFiles = function(path = "/") {
    var page    = 0;
    var data    = [];
    var client  = this;
...
IVTRego6xxController.rest.Client.prototype.listAllFilesRecursive = function(path = "/") {
    var data    = [];
    var client  = this;
...
IVTRego6xxController.rest.Client.prototype.readFile = function(filename) {
    var promise = null;
...
IVTRego6xxController.rest.Client.prototype.writeFile = function(filename, content, mimeType) {
    var promise     = null;
    var formData    = null;
...
IVTRego6xxController.rest.Client.prototype.removeFile = function(filename) {
    var promise = null;
...
IVTRego6xxController.rest.Client.prototype.getPluginInstances = function() {
    return utils.makeRequest({
        method: "GET",
...
IVTRego6xxController.rest.Client.prototype.getSensors = function() {
    return utils.makeRequest({
        method: "GET",
...
IVTRego6xxController.rest.Client.prototype.getSettingKeys = function() {
    return utils.makeRequest({
        method: "GET",
...
IVTRego6xxController.rest.Client.prototype.getSettingByKey = function(key) {
    var promise = null;
...
IVTRego6xxController.rest.Client.prototype.setSetting = function(key, value) {
    var promise = null;
...
IVTRego6xxController.rest.Client.prototype.reset = function() {
    return utils.makeRequest({
        method: "GET",
...
IVTRego6xxController.rest.Client.prototype.fileMgrRemoveFile = function(fileId) {
    var promise = null;
