var IVTRego6xxController = window.IVTRego6xxController || {};

IVTRego6xxController.ws = {};

IVTRego6xxController.ws.getLogLevelStr = function(logLevel) {
    var str = "";
...
IVTRego6xxController.ws.Client = function(options) {
...
IVTRego6xxController.ws.Client.prototype.connect = function(options) {
...
IVTRego6xxController.ws.Client.prototype.disconnect = function(options) {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else {
...
IVTRego6xxController.ws.Client.prototype._onMessage = function(msg) {
    var data        = msg.split(";");
...
IVTRego6xxController.ws.Client.prototype.getDisplayContent = function() {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else {
...
IVTRego6xxController.ws.Client.prototype.getSlots = function() {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else {
...
IVTRego6xxController.ws.Client.prototype.reset = function() {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else {
...
IVTRego6xxController.ws.Client.prototype.getBrightness = function() {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else {
...
IVTRego6xxController.ws.Client.prototype.setBrightness = function(options) {
    return new Promise(function(resolve, reject) {
        var par = "";
...
IVTRego6xxController.ws.Client.prototype.getPlugins = function() {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else {
...
IVTRego6xxController.ws.Client.prototype.install = function(options) {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
...
IVTRego6xxController.ws.Client.prototype.uninstall = function(options) {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
...
IVTRego6xxController.ws.Client.prototype.getLog = function(options) {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else {
...
IVTRego6xxController.ws.Client.prototype.setLog = function(options) {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
...
IVTRego6xxController.ws.Client.prototype.move = function(options) {
    return new Promise(function(resolve, reject) {
        var par = "";
...
IVTRego6xxController.ws.Client.prototype.getSlotDuration = function(options) {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else if ("number" !== typeof options.slotId) {
...
IVTRego6xxController.ws.Client.prototype.setSlotDuration = function(options) {
    return new Promise(function(resolve, reject) {
        var par = "";
        if (null === this._socket) {
            reject();
...
IVTRego6xxController.ws.Client.prototype.getIperf = function(options) {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else {
...
IVTRego6xxController.ws.Client.prototype.startIperf = function(options) {
    return new Promise(function(resolve, reject) {
        var par = "START";
        if (null === this._socket) {
            reject();
...
IVTRego6xxController.ws.Client.prototype.stopIperf = function(options) {
    return new Promise(function(resolve, reject) {
        var par = "STOP";
...
IVTRego6xxController.ws.Client.prototype.triggerButton = function(options) {
    return new Promise(function(resolve, reject) {
        var par = null;
...
IVTRego6xxController.ws.Client.prototype.setFadeEffect = function(options) {
    return new Promise(function(resolve, reject) {
        var par = "";
...
IVTRego6xxController.ws.Client.prototype.getFadeEffect = function() {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
        } else {
...
IVTRego6xxController.ws.Client.prototype.getPluginAlias = function(options) {
    return new Promise(function(resolve, reject) {
        if (null === this._socket) {
            reject();
...
IVTRego6xxController.ws.Client.prototype.setPluginAlias = function(options) {
    return new Promise(function(resolve, reject) {
        var par = "";
        if (null === this._socket) {
            reject();
